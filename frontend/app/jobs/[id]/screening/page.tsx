        ...
        {rubric && (
          <div className="card">
            ...
            <p className="page-subtitle" style={{ margin: "0.35rem 0 0" }}>
              This rubric was generated by AI from the job description — feel free to edit criteria, weights, or
              descriptions below to match how you actually want to screen candidates.
            </p>
